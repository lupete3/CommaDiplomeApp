...
<body>
	...
	<div class="container spacer">
		...
		<div class="col-md-12 spacer">
	          <h3 class="title">LES DEMANDES VALIDEES</span></h3>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT a.id, date_format(a.dateCommande, '%d-%m-%Y') as dateCommande, a.typeDiplome, a.borderau, a.rG1, a.rG2,a.rG3,a.rL1,a.rL2,a.statut FROM commande as a, etudiant as b where a.idEtud = b.id AND a.statut = 'valide' AND a.idEtud = $id ORDER BY a.dateCommande LIMIT $start,$limit");
							
							$res = $bd->query("SELECT COUNT(*) as total FROM commande as a, etudiant as b where a.idEtud = b.id AND a.statut = 'valide' AND a.idEtud = $id");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="demandeValideEtud.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="demandeValideEtud.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="demandeValideEtud.php?page=<?php echo $suiv;?>">
