	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT a.id, date_format(a.dateCommande, '%d-%m-%Y') as dateCommande, a.typeDiplome, a.borderau, a.rG1, a.rG2,a.rG3,a.rL1,a.rL2,a.statut FROM commande as a, etudiant as b where a.idEtud = b.id AND a.statut = 'valide' ORDER BY a.dateCommande LIMIT $start,$limit");
		          		...
		          		<tr>
                                ...
                                <td>
                                	<a href="sendsmsView.php?id=<?php echo $don['id'] ?>">
                                		<button type="button" data-toggle="tooltip" title="Envoyer le message à l'étudiant" class="btn btn-danger editBtn"><span class="fa fa-envelope"> </span></button>
                                	</a>
                                </td>
