                        ...
                        <div class="panel-body text-center">
        					...
        					<form role="form" method="post" action="../access/connect_users.php" class="was-validated">
        						...
        						<select class="form-control" name="funct" required="">
        							...
        							<option value="agent">Agent Service Académique</option>
        							<option value="etudiant">Etudiant</option>
        						</select>	<br>
        						<input type="submit" class="btn btn-danger" name="log_in" value="Se Connecter" />
        						<a href="register.php"><span class="btn btn-primary">S'inscrire</span></a><br>
