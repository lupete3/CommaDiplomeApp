      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.php"><span class="red">ISTM</span>-<span class="warning">BUAKAVU</span></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="apropos.php" class="page-scroll"><i class="fa fa-globe"></i> A propos</a></li>
            <li><a href="#contact" class="page-scroll"><i class="fa fa-envelope"></i> Contactez-nous</a></li>
            <li><a href="view/login.php" class="page-scroll" id="contacts" title="Connectez-vous"><i class="fa fa-user"></i> Se Connecter</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>
